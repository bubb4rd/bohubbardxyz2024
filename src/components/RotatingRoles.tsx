...
export function RotatingRoles({ className = "text-lg sm:text-xl" }: { className?: string }) {
  ...
  return (
    <span
      ...
      style={{ height: "1.35em", minWidth: "24ch" }}
      aria-live="polite"
    >
      <span
        ref={textRef}
        className="absolute inset-x-0 top-0 font-bold whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-[#38bdf8] via-blue-500 to-[#38bdf8]"
      >
        {heroRoles[roleIndex]}
      </span>
    </span>
